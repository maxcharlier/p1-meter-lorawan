// elec_reader.cpp - P1 smart meter reader - parsing DSMR/ESMR telegrams
//
...
// added LoRaWAN payload encoding and over-voltage detection.
...
static ObisField obis_fields[P1_NUM_FIELDS] = {
  ...
  // 1-0:1.4.0(00.051*kW) Current average demand - Active energy import (reset each quarter hour)
  // ObisField('m', "Enrg-Avg-Import-W", "Current average demand - Active energy import", "1-0:1.4.0", '(', '*', AVG_ENERGY_IMPORT_STATS_INDEX),
  ...
  // ObisField('F', "Fails-short-#", "Number of power failures in any phase", "0-0:96.7.21", '(', ')'),
  // ObisField('f', "Fails-long-#", "Number of long power failures in any phase", "0-0:96.7.9", '(', ')'),
  ...
  // ObisField('B', "Cons-L2-W", "Instantaneous power L2 (+P)", "1-0:41.7.0", '(', '*'),
  // ObisField('b', "Prod-L2-W", "Instantaneous power L2 (-P)", "1-0:42.7.0", '(', '*'),
  // ObisField('C', "Cons-L3-W", "Instantaneous power L3 (+P)", "1-0:61.7.0", '(', '*'),
  // ObisField('c', "Prod-L3-W", "Instantaneous power L3 (-P)", "1-0:62.7.0", '(', '*'),
  // ObisField('G', "Cons-Gas-m3", "Last 5-minute value gas delivered to client", "0-1:24.2.1", '(', '*'),
};
